 ...
 */
    ...
    session_start();
    $_SESSION['scriptcase']['grid_configuracao_cores']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
    //check tmp
...
<?php
     if ($export_ajax == 'S') {
?>
         parent.nm_gp_xls_conf(tp_xls, res_cons, use_pass, '<?php echo NM_encode_input($export_ajax); ?>', 'xls', false);return false;
<?php
     }
     else if ($export_ajax == 'R') {
?>
         parent.nm_gp_xls_conf(tp_xls, res_cons, use_pass, '<?php echo NM_encode_input($export_ajax); ?>', 'xls_res', false);return false;
<?php
     } else {
?>
         parent.nm_gp_xls_conf(tp_xls, res_cons, use_pass, '<?php echo NM_encode_input($export_ajax); ?>', '', false);return false;
<?php
     }
?>
/*--------*/

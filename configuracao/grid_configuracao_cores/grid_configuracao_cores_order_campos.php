...
<?php
   ...
   $Ord_Cmp = new grid_configuracao_cores_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_configuracao_cores_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select_orig'] = array();
   }
   ...
   $tab_converte["Inicio"]   = "inicio";
   $tab_labels["inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["inicio"] : "Inicio";
   $tab_ger_campos['fim'] = "on";
   $tab_def_campos['fim'] = "Fim";
   $tab_converte["Fim"]   = "fim";
   $tab_labels["fim"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["fim"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["fim"] : "Fim";
   $tab_ger_campos['cor_fundo'] = "on";
   $tab_def_campos['cor_fundo'] = "Cor_Fundo";
   $tab_converte["Cor_Fundo"]   = "cor_fundo";
   $tab_labels["cor_fundo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["cor_fundo"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["cor_fundo"] : "Cor Fundo";
   $tab_ger_campos['cor_fonte'] = "on";
   $tab_def_campos['cor_fonte'] = "Cor_Fonte";
   $tab_converte["Cor_Fonte"]   = "cor_fonte";
   $tab_labels["cor_fonte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["cor_fonte"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['labels']["cor_fonte"] : "Cor Fonte";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_configuracao_cores_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_configuracao_cores']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bok", "document.Fsel_ord.fsel_ok.value='cmp';proc_btn_ord('f_sel_sub','submit_form_Fsel_ord()')", "document.Fsel_ord.fsel_ok.value='cmp';proc_btn_ord('f_sel_sub','submit_form_Fsel_ord()')", "f_sel_sub", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
   }
   else
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bapply", "proc_btn_ord('f_sel_sub','scSubmitOrderCampos(\\'" . NM_encode_input($tbar_pos) . "\\', \\'cmp\\')')", "proc_btn_ord('f_sel_sub','scSubmitOrderCampos(\\'" . NM_encode_input($tbar_pos) . "\\', \\'cmp\\')')", "f_sel_sub", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
   }
?>
...
<?php
   ...
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "brestore", "proc_btn_ord('Brestore_ord','restore_ord()')", "proc_btn_ord('Brestore_ord','restore_ord()')", "Brestore_ord", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
   }
   else
...
<?php
   ...
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bsair", "self.parent.tb_remove()", "self.parent.tb_remove()", "Bsair_ord", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
   }
   else
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnOrderCamposHide('" . NM_encode_input($tbar_pos) . "')", "scBtnOrderCamposHide('" . NM_encode_input($tbar_pos) . "')", "Bsair_ord", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
   }
?>

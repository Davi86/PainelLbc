<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="inicio" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['inicio']); ?>">
<input type="hidden" name="fim" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['fim']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuracao_cores']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_configuracao_cores"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuracao_cores']['where_detal']))
  {
?>  

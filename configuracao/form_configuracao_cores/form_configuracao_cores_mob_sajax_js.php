  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_configuracao_cores_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate inicio
  function do_ajax_form_configuracao_cores_mob_validate_inicio()
  {
    var nomeCampo_inicio = "inicio";
    var var_inicio = scAjaxGetFieldText(nomeCampo_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_mob_validate_inicio(var_inicio, var_script_case_init, do_ajax_form_configuracao_cores_mob_validate_inicio_cb);
  } // do_ajax_form_configuracao_cores_mob_validate_inicio

  function do_ajax_form_configuracao_cores_mob_validate_inicio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_mob_validate_inicio_cb

  // ---------- Validate fim
  function do_ajax_form_configuracao_cores_mob_validate_fim()
  {
    var nomeCampo_fim = "fim";
    var var_fim = scAjaxGetFieldText(nomeCampo_fim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_mob_validate_fim(var_fim, var_script_case_init, do_ajax_form_configuracao_cores_mob_validate_fim_cb);
  } // do_ajax_form_configuracao_cores_mob_validate_fim

  function do_ajax_form_configuracao_cores_mob_validate_fim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fim";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_mob_validate_fim_cb

  // ---------- Validate cor_fundo
  function do_ajax_form_configuracao_cores_mob_validate_cor_fundo()
  {
    var nomeCampo_cor_fundo = "cor_fundo";
    var var_cor_fundo = scAjaxGetFieldText(nomeCampo_cor_fundo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_mob_validate_cor_fundo(var_cor_fundo, var_script_case_init, do_ajax_form_configuracao_cores_mob_validate_cor_fundo_cb);
  } // do_ajax_form_configuracao_cores_mob_validate_cor_fundo

  function do_ajax_form_configuracao_cores_mob_validate_cor_fundo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cor_fundo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_mob_validate_cor_fundo_cb

  // ---------- Validate cor_fonte
  function do_ajax_form_configuracao_cores_mob_validate_cor_fonte()
  {
    var nomeCampo_cor_fonte = "cor_fonte";
    var var_cor_fonte = scAjaxGetFieldText(nomeCampo_cor_fonte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_mob_validate_cor_fonte(var_cor_fonte, var_script_case_init, do_ajax_form_configuracao_cores_mob_validate_cor_fonte_cb);
  } // do_ajax_form_configuracao_cores_mob_validate_cor_fonte

  function do_ajax_form_configuracao_cores_mob_validate_cor_fonte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cor_fonte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_mob_validate_cor_fonte_cb
  // ---------- Form
  function do_ajax_form_configuracao_cores_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_configuracao_cores_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_inicio = scAjaxGetFieldText("inicio");
    var var_fim = scAjaxGetFieldText("fim");
    var var_cor_fundo = scAjaxGetFieldText("cor_fundo");
    var var_cor_fonte = scAjaxGetFieldText("cor_fonte");
    ...
    scAjaxProcOn();
    x_ajax_form_configuracao_cores_mob_submit_form(var_inicio, var_fim, var_cor_fundo, var_cor_fonte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_configuracao_cores_mob_submit_form_cb);
  } // do_ajax_form_configuracao_cores_mob_submit_form

  function do_ajax_form_configuracao_cores_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fim");
      scAjaxHideErrorDisplay("cor_fundo");
      scAjaxHideErrorDisplay("cor_fonte");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_configuracao_cores_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_configuracao_cores_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cor_fundo");
    scAjaxHideErrorDisplay("cor_fonte");
    var var_inicio = document.F2.inicio.value;
    var var_fim = document.F2.fim.value;
    ...
    scAjaxProcOn();
    x_ajax_form_configuracao_cores_mob_navigate_form(var_inicio, var_fim, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_configuracao_cores_mob_navigate_form_cb);
  } // do_ajax_form_configuracao_cores_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuracao_cores_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_configuracao_cores_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_configuracao_cores_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.inicio.value = scAjaxGetKeyValue("inicio");
    document.F2.fim.value = scAjaxGetKeyValue("fim");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_configuracao_cores_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_configuracao_cores_mob_navigate_form_cb
  function sc_hide_form_configuracao_cores_mob_form()
  {
  ...
  ajax_field_list[1] = "fim";
  ajax_field_list[2] = "cor_fundo";
  ajax_field_list[3] = "cor_fonte";
  ...
  var ajax_error_list = {
    ...
    "fim": {"label": "Fim", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cor_fundo": {"label": "Cor Fundo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cor_fonte": {"label": "Cor Fonte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fim"][1] = "fim";
  ajax_field_mult["cor_fundo"][1] = "cor_fundo";
  ajax_field_mult["cor_fonte"][1] = "cor_fonte";

  var ajax_field_id = {
    "inicio": new Array("hidden_field_label_inicio", "hidden_field_data_inicio"),
    "fim": new Array("hidden_field_label_fim", "hidden_field_data_fim"),
    "cor_fundo": new Array("hidden_field_label_cor_fundo", "hidden_field_data_cor_fundo"),
    "cor_fonte": new Array("hidden_field_label_cor_fonte", "hidden_field_data_cor_fonte")
  };

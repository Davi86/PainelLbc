  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_configuracao_cores" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate inicio
  function do_ajax_form_configuracao_cores_validate_inicio()
  {
    var nomeCampo_inicio = "inicio";
    var var_inicio = scAjaxGetFieldText(nomeCampo_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_validate_inicio(var_inicio, var_script_case_init, do_ajax_form_configuracao_cores_validate_inicio_cb);
  } // do_ajax_form_configuracao_cores_validate_inicio

  function do_ajax_form_configuracao_cores_validate_inicio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_validate_inicio_cb

  // ---------- Validate fim
  function do_ajax_form_configuracao_cores_validate_fim()
  {
    var nomeCampo_fim = "fim";
    var var_fim = scAjaxGetFieldText(nomeCampo_fim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_validate_fim(var_fim, var_script_case_init, do_ajax_form_configuracao_cores_validate_fim_cb);
  } // do_ajax_form_configuracao_cores_validate_fim

  function do_ajax_form_configuracao_cores_validate_fim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fim";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_validate_fim_cb

  // ---------- Validate cor_fundo
  function do_ajax_form_configuracao_cores_validate_cor_fundo()
  {
    var nomeCampo_cor_fundo = "cor_fundo";
    var var_cor_fundo = scAjaxGetFieldText(nomeCampo_cor_fundo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_validate_cor_fundo(var_cor_fundo, var_script_case_init, do_ajax_form_configuracao_cores_validate_cor_fundo_cb);
  } // do_ajax_form_configuracao_cores_validate_cor_fundo

  function do_ajax_form_configuracao_cores_validate_cor_fundo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_validate_cor_fundo_cb

  // ---------- Validate cor_fonte
  function do_ajax_form_configuracao_cores_validate_cor_fonte()
  {
    var nomeCampo_cor_fonte = "cor_fonte";
    var var_cor_fonte = scAjaxGetFieldText(nomeCampo_cor_fonte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuracao_cores_validate_cor_fonte(var_cor_fonte, var_script_case_init, do_ajax_form_configuracao_cores_validate_cor_fonte_cb);
  } // do_ajax_form_configuracao_cores_validate_cor_fonte

  function do_ajax_form_configuracao_cores_validate_cor_fonte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuracao_cores_validate_cor_fonte_cb
  // ---------- Form
  function do_ajax_form_configuracao_cores_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_configuracao_cores_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_configuracao_cores_submit_form(var_inicio, var_fim, var_cor_fundo, var_cor_fonte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_configuracao_cores_submit_form_cb);
  } // do_ajax_form_configuracao_cores_submit_form

  function do_ajax_form_configuracao_cores_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_configuracao_cores_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_configuracao_cores_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_configuracao_cores_navigate_form(var_inicio, var_fim, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_configuracao_cores_navigate_form_cb);
  } // do_ajax_form_configuracao_cores_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuracao_cores']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_configuracao_cores_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_configuracao_cores_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_configuracao_cores_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_configuracao_cores_navigate_form_cb
  function sc_hide_form_configuracao_cores_form()
  {
